package com.mike.curso.springboot.di.factura.springbootdifactura;
...
import com.mike.curso.springboot.di.factura.springbootdifactura.models.Item;
import com.mike.curso.springboot.di.factura.springbootdifactura.models.Product;
...
public class AppConfig {
    ...
    List<Item> itemsInvoice() {
        ...
        Product p1 = new Product("Camra Sony", 800);
